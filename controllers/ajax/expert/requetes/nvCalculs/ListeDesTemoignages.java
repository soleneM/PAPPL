...
public class ListeDesTemoignages {

	public static ResultSet calculeListeDesTemoignages(Map<String,String> info) throws ParseException, SQLException {
		...
		if (info.get("periode").equals("all")) {
			...
			String statement = ""
				...
				+ "GROUP BY m.membre_nom ";
			listeDesTemoignages = connection.prepareStatement(statement); 
			listeDesTemoignages.setDate(1,new java.sql.Date(date1.getTimeInMillis()));
			listeDesTemoignages.setDate(2,new java.sql.Date(date2.getTimeInMillis()));	
		}
