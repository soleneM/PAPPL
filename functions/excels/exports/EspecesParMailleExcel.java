...
public class EspecesParMailleExcel extends Excel {

	public EspecesParMailleExcel(Map<String,String> info, ResultSet especesParMaille) throws SQLException{
		super();
		Sheet sheet = wb.createSheet("Especes par maille");
