...
public class ListeDesTemoignagesExcel extends Excel{

	public ListeDesTemoignagesExcel(Map<String,String> info, ResultSet listeDesTemoins) throws IOException, SQLException{
		super();
