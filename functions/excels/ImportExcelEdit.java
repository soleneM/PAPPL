...
public class ImportExcelEdit extends Excel{
	private Calendar creationTime;
	private Sheet sheet;
	private StringBuilder errorReport;
	private boolean noError = true;
	
	private List<RowCheckEdit> temoignages = new ArrayList<RowCheckEdit>();
	...
	public void checkRows(){
		...
		while((row=sheet.getRow(i))!=null && row.getCell(0)!=null){
			RowCheckEdit rc = new RowCheckEdit(row,i,errorReport,this.creationTime);
			rc.checkRow();
	...
	public void saveToDatabase() {
		for(RowCheckEdit temoignage : temoignages){
